...
COPY (select * from user_likes_repins order by repins_no,likes_no,actor_count desc) TO '/Users/admin/Desktop/data/opendata_klout/data/pinterest/user_likes_repins.csv' DELIMITER ',' CSV HEADER;
